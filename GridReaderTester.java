/**
 * File: GridReaderTester
 * Purpose: test the GridReader class
 * Date: Sep 15, 2022
...
public class GridReaderTester {
    public static void main(String[] args) {
        ...
        final String EOF = "\\Z";
        // use this file
        String FILE_NAME = "GridReaderTester.java";
        ...
        try {
            ...
            GridReader reader = new GridReader(FILE_NAME);
