...
### Homework 1  GridReader (for grid based games)
...
For this assignment, you'll be developing on java class `GridReader` and one java program `GameFileTester` that will test the class. 
...
The first tests will test the `GridReader` on one file.  There are 4 tests for 20 points each.
